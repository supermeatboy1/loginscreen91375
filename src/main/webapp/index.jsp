...
<div style="width: 100%; overflow: auto;">
	<div class="right_column center">
		...
		<div class="user_input_div">
			...
			<div class="forgor">
				<a href="#" class="forgor_link">Forgot your password?</a>
			</div>
		</div>
		<br><br>
	</div>
	...
	<div class="footer center">
		...
		<p>&#169; 1997-2023 Blackboard Inc. All Rights Reserved.</p>
		<ul class="center">
			<li class="horizontal_list_element"><a href="#" class="footer_link">Help</a></li>
